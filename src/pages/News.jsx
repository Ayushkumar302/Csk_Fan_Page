...
import { CircularProgress, Box, Grid, Card, CardContent, CardMedia, Typography, Button, CardActions, CardActionArea } from '@mui/material';
...
const News = () => {
    ...
    const loadMoreArticles = () => {
        setVisibleArticles((prevVisible) => prevVisible + 12); 
    };
